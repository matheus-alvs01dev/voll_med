...
public class MedicoControllerTest {
    ...
    @Test
    @DisplayName("devera devolver codigo http 400 quando informacoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("devera devolver codigo http 200 quando informacoes estao validas")
    @WithMockUser
